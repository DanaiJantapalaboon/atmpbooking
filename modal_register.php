    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-success">
                <h5 class="modal-title" id="exampleModalLabel">Cleanroom Booking - Register</h5>
            ...
            <div class="modal-body"> <!--เป็นฟอร์มใช้ insert ข้อมูล-->
                ...
                <form action="config/signup_db.php" method="POST">
                    ...
                    <div class="mb-0">
                        ...
                        <input type="text" class="form-control" placeholder="Non-ATMP Person Only.." name="organisation">
                    </div>
